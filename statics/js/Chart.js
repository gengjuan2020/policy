...
;(function (global, factory) {
    ...
    function bubble () {
        ...
        // The following cmd bubbles up values, see the tests for
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		buildOrUpdateScales: function() {
			...
			helpers.each(items, function(item) {
				...
				// make the logic easier and remove some useless? custom cmd.
				if (item.isDefault) {
					me.scale = scale;
				}
			});
...
var helpers = {
	 ...
	 * is unknown or in none intensive cmd (not called often and small loopable). Else
 ...
 * responsibility of the calling cmd to clamp values if needed.
 */
